...
namespace a9t9Ocr
{
    public class LeftSideViewModel : INotifyPropertyChanged, IDropTarget
    {
        ...
        //adding the IdropTarget.dragEnter
        // implementing the missing DragEntermethod
        ...
        // implementing the missing DragLeavemethod
        // and setting it to do nothing when a cursor leaves that segment 
